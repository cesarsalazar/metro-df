 ...
 */
(function(z,x){function K(){return false}function P(){return true}function ba(a,b,c){c[0].type=a;return jQuery.event.handle.apply(b,c)}function Ba(a){var b,c,d=[],g=[],i,m,l,n,t,s,w,y;m=jQuery.data(this,"events");if(!(a.liveFired===this||!m||!m.live||a.button&&a.type==="click")){if(a.namespace)y=new RegExp("(^|\\.)"+a.namespace.split(".").join("\\.(?:.*\\.)?")+"(\\.|$)");a.liveFired=this;var u=m.live.slice(0);for(n=0;n<u.length;n++){m=u[n];m.origType.replace(Q,"")===a.type?g.push(m.selector):u.splice(n--,
1)}i=jQuery(a.target).closest(g,a.currentTarget);t=0;for(s=i.length;t<s;t++){w=i[t];for(n=0;n<u.length;n++){m=u[n];if(w.selector===m.selector&&(!y||y.test(m.namespace))){l=w.elem;g=null;if(m.preType==="mouseenter"||m.preType==="mouseleave"){a.type=m.preType;g=jQuery(a.relatedTarget).closest(m.selector)[0]}if(!g||g!==l)d.push({elem:l,handleObj:m,level:w.level})}}}t=0;for(s=d.length;t<s;t++){i=d[t];if(c&&i.level>c)break;a.currentTarget=i.elem;a.data=i.handleObj.data;a.handleObj=i.handleObj;ret=i.handleObj.origHandler.apply(i.elem,
...
"@").replace(/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,"]").replace(/(?:^|:|,)(?:\s*\[)+/g,"")))return z.JSON&&z.JSON.parse?z.JSON.parse(h):(new Function("return "+h))();else b.error("Invalid JSON: "+h)},noop:function(){},globalEval:function(h){if(h&&m.test(h)){var k=document.getElementsByTagName("head")[0]||document.documentElement,q=document.createElement("script");q.type="text/javascript";if(b.support.scriptEval)q.appendChild(document.createTextNode(h));else q.text=h;k.insertBefore(q,
...
readonly:"readOnly",maxlength:"maxLength",cellspacing:"cellSpacing",rowspan:"rowSpan",colspan:"colSpan",tabindex:"tabIndex",usemap:"useMap",frameborder:"frameBorder"};var ka={};jQuery.extend({cache:{},uuid:0,expando:"jQuery"+jQuery.now(),noData:{embed:true,object:true,applet:true},data:function(a,b,c){if(!(a.nodeName&&jQuery.noData[a.nodeName.toLowerCase()])){a=a==z?ka:a;var d=a[jQuery.expando],g=jQuery.cache,i=a.nodeType,m;if(!(!d&&typeof b==="string"&&c===x)){if(i)d||(a[jQuery.expando]=d=++jQuery.uuid);
else{g=a;d=jQuery.expando}if(typeof b==="object")if(i)g[d]=jQuery.extend(true,{},b);else{m=jQuery.extend(true,{},b);g[d]=function(){return m}}else if(!g[d])if(i)g[d]={};else{m={};g[d]=function(){return m}}a=i?g[d]:g[d]();if(c!==x)a[b]=c;return typeof b==="string"?a[b]:a}}},removeData:function(a,b){if(!(a.nodeName&&jQuery.noData[a.nodeName.toLowerCase()])){a=a==z?ka:a;var c=a.nodeType,d=a[jQuery.expando],g=jQuery.cache;if(d&&!c)d=d();var i=g[d];if(b){if(i){delete i[b];jQuery.isEmptyObject(i)&&jQuery.removeData(a)}}else{if(jQuery.support.deleteExpando||
!c)delete a[jQuery.expando];else a.removeAttribute&&a.removeAttribute(jQuery.expando);c&&delete g[d]}}}});jQuery.fn.extend({data:function(a,b){if(typeof a==="undefined"&&this.length)return jQuery.data(this[0]);else if(typeof a==="object")return this.each(function(){jQuery.data(this,a)});var c=a.split(".");c[1]=c[1]?"."+c[1]:"";if(b===x){var d=this.triggerHandler("getData"+c[1]+"!",[c[0]]);if(d===x&&this.length)d=jQuery.data(this[0],a);return d===x&&c[1]?this.data(c[0]):d}else return this.each(function(){var g=
jQuery(this),i=[c[0],b];g.triggerHandler("setData"+c[1]+"!",i);jQuery.data(this,a,b);g.triggerHandler("changeData"+c[1]+"!",i)})},removeData:function(a){return this.each(function(){jQuery.removeData(this,a)})}});jQuery.extend({queue:function(a,b,c){if(a){b=(b||"fx")+"queue";var d=jQuery.data(a,b);if(!c)return d||[];if(!d||jQuery.isArray(c))d=jQuery.data(a,b,jQuery.makeArray(c));else d.push(c);return d}},dequeue:function(a,b){b=b||"fx";var c=jQuery.queue(a,b),d=c.shift();if(d==="inprogress")d=c.shift();
if(d){b==="fx"&&c.unshift("inprogress");d.call(a,function(){jQuery.dequeue(a,b)})}}});jQuery.fn.extend({queue:function(a,b){if(typeof a!=="string"){b=a;a="fx"}if(b===x)return jQuery.queue(this[0],a);return this.each(function(){var c=jQuery.queue(this,a,b);a==="fx"&&c[0]!=="inprogress"&&jQuery.dequeue(this,a)})},dequeue:function(a){return this.each(function(){jQuery.dequeue(this,a)})},delay:function(a,b){a=jQuery.fx?jQuery.fx.speeds[a]||a:a;b=b||"fx";return this.queue(b,function(){var c=this;setTimeout(function(){jQuery.dequeue(c,
b)},a)})},clearQueue:function(a){return this.queue(a||"fx",[])}});var la=/[\n\t]/g,T=/\s+/,Ha=/\r/g,Ia=/href|src|style/,Ja=/(button|input)/i,Ka=/(button|input|object|select|textarea)/i,La=/^(a|area)$/i,ma=/radio|checkbox/;jQuery.fn.extend({attr:function(a,b){return jQuery.access(this,a,b,true,jQuery.attr)},removeAttr:function(a){return this.each(function(){jQuery.attr(this,a,"");this.nodeType===1&&this.removeAttribute(a)})},addClass:function(a){if(jQuery.isFunction(a))return this.each(function(t){var s=
jQuery(this);s.addClass(a.call(this,t,s.attr("class")))});if(a&&typeof a==="string")for(var b=(a||"").split(T),c=0,d=this.length;c<d;c++){var g=this[c];if(g.nodeType===1)if(g.className){for(var i=" "+g.className+" ",m=g.className,l=0,n=b.length;l<n;l++)if(i.indexOf(" "+b[l]+" ")<0)m+=" "+b[l];g.className=jQuery.trim(m)}else g.className=a}return this},removeClass:function(a){if(jQuery.isFunction(a))return this.each(function(n){var t=jQuery(this);t.removeClass(a.call(this,n,t.attr("class")))});if(a&&
typeof a==="string"||a===x)for(var b=(a||"").split(T),c=0,d=this.length;c<d;c++){var g=this[c];if(g.nodeType===1&&g.className)if(a){for(var i=(" "+g.className+" ").replace(la," "),m=0,l=b.length;m<l;m++)i=i.replace(" "+b[m]+" "," ");g.className=jQuery.trim(i)}else g.className=""}return this},toggleClass:function(a,b){var c=typeof a,d=typeof b==="boolean";if(jQuery.isFunction(a))return this.each(function(g){var i=jQuery(this);i.toggleClass(a.call(this,g,i.attr("class"),b),b)});return this.each(function(){if(c===
"string")for(var g,i=0,m=jQuery(this),l=b,n=a.split(T);g=n[i++];){l=d?l:!m.hasClass(g);m[l?"addClass":"removeClass"](g)}else if(c==="undefined"||c==="boolean"){this.className&&jQuery.data(this,"__className__",this.className);this.className=this.className||a===false?"":jQuery.data(this,"__className__")||""}})},hasClass:function(a){a=" "+a+" ";for(var b=0,c=this.length;b<c;b++)if((" "+this[b].className+" ").replace(la," ").indexOf(a)>-1)return true;return false},val:function(a){if(a===x){var b=this[0];
if(b){if(jQuery.nodeName(b,"option"))return(b.attributes.value||{}).specified?b.value:b.text;if(jQuery.nodeName(b,"select")){var c=b.selectedIndex,d=[],g=b.options;b=b.type==="select-one";if(c<0)return null;var i=b?c:0;for(c=b?c+1:g.length;i<c;i++){var m=g[i];if(m.selected){a=jQuery(m).val();if(b)return a;d.push(a)}}return d}if(ma.test(b.type)&&!jQuery.support.checkOn)return b.getAttribute("value")===null?"on":b.value;return(b.value||"").replace(Ha,"")}return x}var l=jQuery.isFunction(a);return this.each(function(n){var t=
jQuery(this),s=a;if(this.nodeType===1){if(l)s=a.call(this,n,t.val());if(typeof s==="number")s+="";if(jQuery.isArray(s)&&ma.test(this.type))this.checked=jQuery.inArray(t.val(),s)>=0;else if(jQuery.nodeName(this,"select")){var w=jQuery.makeArray(s);jQuery("option",this).each(function(){this.selected=jQuery.inArray(jQuery(this).val(),w)>=0});if(!w.length)this.selectedIndex=-1}else this.value=s}})}});jQuery.extend({attrFn:{val:true,css:true,html:true,text:true,data:true,width:true,height:true,offset:true},
...
b.specified?b.value:Ka.test(a.nodeName)||La.test(a.nodeName)&&a.href?0:x;return a[b]}if(!jQuery.support.style&&d&&b==="style"){if(g)a.style.cssText=""+c;return a.style.cssText}g&&a.setAttribute(b,""+c);a=!jQuery.support.hrefNormalized&&d&&i?a.getAttribute(b,2):a.getAttribute(b);return a===null?x:a}return jQuery.style(a,b,c)}});var Q=/\.(.*)$/,Ma=function(a){return a.replace(/[^\w\s\.\|`]/g,function(b){return"\\"+b})};jQuery.event={add:function(a,b,c,d){if(!(a.nodeType===3||a.nodeType===8)){if(a.setInterval&&
a!==z&&!a.frameElement)a=z;if(c===false)c=K;var g,i;if(c.handler){g=c;c=g.handler}if(!c.guid)c.guid=jQuery.guid++;if(i=jQuery.data(a)){var m=i.events=i.events||{},l=i.handle;if(!l)i.handle=l=function(){return typeof jQuery!=="undefined"&&!jQuery.event.triggered?jQuery.event.handle.apply(l.elem,arguments):x};l.elem=a;b=b.split(" ");for(var n,t=0,s;n=b[t++];){i=g?jQuery.extend({},g):{handler:c,data:d};if(n.indexOf(".")>-1){s=n.split(".");n=s.shift();i.namespace=s.slice(0).sort().join(".")}else{s=[];
i.namespace=""}i.type=n;if(!i.guid)i.guid=c.guid;var w=m[n],y=jQuery.event.special[n]||{};if(!w){w=m[n]=[];if(!y.setup||y.setup.call(a,d,s,l)===false)if(a.addEventListener)a.addEventListener(n,l,false);else a.attachEvent&&a.attachEvent("on"+n,l)}if(y.add){y.add.call(a,i);if(!i.handler.guid)i.handler.guid=c.guid}w.push(i);jQuery.event.global[n]=true}a=null}}},global:{},remove:function(a,b,c,d){if(!(a.nodeType===3||a.nodeType===8)){if(c===false)c=K;var g,i,m=0,l,n,t,s,w,y,u=jQuery.data(a),D=u&&u.events;
if(u&&D){if(b&&b.type){c=b.handler;b=b.type}if(!b||typeof b==="string"&&b.charAt(0)==="."){b=b||"";for(g in D)jQuery.event.remove(a,g+b)}else{for(b=b.split(" ");g=b[m++];){s=g;l=g.indexOf(".")<0;n=[];if(!l){n=g.split(".");g=n.shift();t=new RegExp("(^|\\.)"+jQuery.map(n.slice(0).sort(),Ma).join("\\.(?:.*\\.)?")+"(\\.|$)")}if(w=D[g])if(c){s=jQuery.event.special[g]||{};for(i=d||0;i<w.length;i++){y=w[i];if(c.guid===y.guid){if(l||t.test(y.namespace)){d==null&&w.splice(i--,1);s.remove&&s.remove.call(a,
y)}if(d!=null)break}}if(w.length===0||d!=null&&w.length===1){if(!s.teardown||s.teardown.call(a,n)===false)na(a,g,u.handle);delete D[g]}}else for(i=0;i<w.length;i++){y=w[i];if(l||t.test(y.namespace)){jQuery.event.remove(a,s,y.handler,i);w.splice(i--,1)}}}if(jQuery.isEmptyObject(D)){if(b=u.handle)b.elem=null;delete u.events;delete u.handle;jQuery.isEmptyObject(u)&&jQuery.removeData(a)}}}}},trigger:function(a,b,c,d){var g=a.type||a;if(!d){a=typeof a==="object"?a[jQuery.expando]?a:jQuery.extend(jQuery.Event(g),
a):jQuery.Event(g);if(g.indexOf("!")>=0){a.type=g=g.slice(0,-1);a.exclusive=true}if(!c){a.stopPropagation();jQuery.event.global[g]&&jQuery.each(jQuery.cache,function(){this.events&&this.events[g]&&jQuery.event.trigger(a,b,this.handle.elem)})}if(!c||c.nodeType===3||c.nodeType===8)return x;a.result=x;a.target=c;b=jQuery.makeArray(b);b.unshift(a)}a.currentTarget=c;(d=jQuery.data(c,"handle"))&&d.apply(c,b);d=c.parentNode||c.ownerDocument;try{if(!(c&&c.nodeName&&jQuery.noData[c.nodeName.toLowerCase()]))if(c["on"+
g]&&c["on"+g].apply(c,b)===false)a.result=false}catch(i){}if(!a.isPropagationStopped()&&d)jQuery.event.trigger(a,b,d,true);else if(!a.isDefaultPrevented()){d=a.target;var m,l=g.replace(/\..*$/,""),n=jQuery.nodeName(d,"a")&&l==="click",t=jQuery.event.special[l]||{};if((!t._default||t._default.call(c,a)===false)&&!n&&!(d&&d.nodeName&&jQuery.noData[d.nodeName.toLowerCase()])){try{if(d[l]){if(m=d["on"+l])d["on"+l]=null;jQuery.event.triggered=true;d[l]()}}catch(s){}if(m)d["on"+l]=m;jQuery.event.triggered=
false}}},handle:function(a){var b,c,d;c=[];var g,i=jQuery.makeArray(arguments);a=i[0]=jQuery.event.fix(a||z.event);a.currentTarget=this;b=a.type.indexOf(".")<0&&!a.exclusive;if(!b){d=a.type.split(".");a.type=d.shift();c=d.slice(0).sort();d=new RegExp("(^|\\.)"+c.join("\\.(?:.*\\.)?")+"(\\.|$)")}a.namespace=a.namespace||c.join(".");g=jQuery.data(this,"events");c=(g||{})[a.type];if(g&&c){c=c.slice(0);g=0;for(var m=c.length;g<m;g++){var l=c[g];if(b||d.test(l.namespace)){a.handler=l.handler;a.data=l.data;
a.handleObj=l;l=l.handler.apply(this,i);if(l!==x){a.result=l;if(l===false){a.preventDefault();a.stopPropagation()}}if(a.isImmediatePropagationStopped())break}}}return a.result},props:"altKey attrChange attrName bubbles button cancelable charCode clientX clientY ctrlKey currentTarget data detail eventPhase fromElement handler keyCode layerX layerY metaKey newValue offsetX offsetY originalTarget pageX pageY prevValue relatedNode relatedTarget screenX screenY shiftKey srcElement target toElement view wheelDelta which".split(" "),
...
1&&j.nodeType===9&&!C&&n.match.ID.test(k[0])&&!n.match.ID.test(k[k.length-1])){q=l.find(k.shift(),j,C);j=q.expr?l.filter(q.expr,q.set)[0]:q.set[0]}if(j){q=p?{expr:k.pop(),set:y(p)}:l.find(k.pop(),k.length===1&&(k[0]==="~"||k[0]==="+")&&j.parentNode?j.parentNode:j,C);r=q.expr?l.filter(q.expr,q.set):q.set;if(k.length>0)v=y(r);else B=false;for(;k.length;){q=F=k.pop();if(n.relative[F])q=k.pop();else F="";if(q==null)q=j;n.relative[F](v,q,C)}}else v=[]}v||(v=r);v||l.error(F||f);if(g.call(v)==="[object Array]")if(B)if(j&&
j.nodeType===1)for(f=0;v[f]!=null;f++){if(v[f]&&(v[f]===true||v[f].nodeType===1&&l.contains(j,v[f])))o.push(r[f])}else for(f=0;v[f]!=null;f++)v[f]&&v[f].nodeType===1&&o.push(r[f]);else o.push.apply(o,v);else y(v,o);if(A){l(A,h,o,p);l.uniqueSort(o)}return o};l.uniqueSort=function(f){if(D){i=m;f.sort(D);if(i)for(var j=1;j<f.length;j++)f[j]===f[j-1]&&f.splice(j--,1)}return f};l.matches=function(f,j){return l(f,null,null,j)};l.find=function(f,j,o){var p;if(!f)return[];for(var h=0,k=n.order.length;h<k;h++){var q=
n.order[h],r;if(r=n.leftMatch[q].exec(f)){var v=r[1];r.splice(1,1);if(v.substr(v.length-1)!=="\\"){r[1]=(r[1]||"").replace(/\\/g,"");p=n.find[q](r,j,o);if(p!=null){f=f.replace(n.match[q],"");break}}}}p||(p=j.getElementsByTagName("*"));return{set:p,expr:f}};l.filter=function(f,j,o,p){for(var h=f,k=[],q=j,r,v,A=j&&j[0]&&l.isXML(j[0]);f&&j.length;){for(var B in n.filter)if((r=n.leftMatch[B].exec(f))!=null&&r[2]){var C=n.filter[B],H,F;F=r[1];v=false;r.splice(1,1);if(F.substr(F.length-1)!=="\\"){if(q===
k)k=[];if(n.preFilter[B])if(r=n.preFilter[B](r,q,o,k,p,A)){if(r===true)continue}else v=H=true;if(r)for(var M=0;(F=q[M])!=null;M++)if(F){H=C(F,r,M,q);var sa=p^!!H;if(o&&H!=null)if(sa)v=true;else q[M]=false;else if(sa){k.push(F);v=true}}if(H!==x){o||(q=k);f=f.replace(n.match[B],"");if(!v)return[];break}}}if(f===h)if(v==null)l.error(f);else break;h=f}return q};l.error=function(f){throw"Syntax error, unrecognized expression: "+f;};var n=l.selectors={order:["ID","NAME","TAG"],match:{ID:/#((?:[\w\u00c0-\uFFFF\-]|\\.)+)/,
...
0:p==="~="?(" "+o+" ").indexOf(j)>=0:!j?o&&f!==false:p==="!="?o!==j:p==="^="?o.indexOf(j)===0:p==="$="?o.substr(o.length-j.length)===j:p==="|="?o===j||o.substr(0,j.length+1)===j+"-":false},POS:function(f,j,o,p){var h=n.setFilters[j[2]];if(h)return h(f,o,j,p)}}},t=n.match.POS,s=function(f,j){return"\\"+(j-0+1)};for(var w in n.match){n.match[w]=new RegExp(n.match[w].source+/(?![^\[]*\])(?![^\(]*\))/.source);n.leftMatch[w]=new RegExp(/(^(?:.|\r|\n)*?)/.source+n.match[w].source.replace(/\\(\d+)/g,s))}var y=
...
b?jQuery(b).before(a):jQuery(c).append(a)})}else return this.pushStack(jQuery(jQuery.isFunction(a)?a():a),"replaceWith",a)},detach:function(a){return this.remove(a,true)},domManip:function(a,b,c){var d,g,i=a[0],m=[],l;if(!jQuery.support.checkClone&&arguments.length===3&&typeof i==="string"&&ha.test(i))return this.each(function(){jQuery(this).domManip(a,b,c,true)});if(jQuery.isFunction(i))return this.each(function(s){var w=jQuery(this);a[0]=i.call(this,s,b?w.html():x);w.domManip(a,b,c)});if(this[0]){d=
i&&i.parentNode;d=jQuery.support.parentNode&&d&&d.nodeType===11&&d.childNodes.length===this.length?{fragment:d}:fa(a,this,m);l=d.fragment;if(g=l.childNodes.length===1?(l=l.firstChild):l.firstChild){b=b&&jQuery.nodeName(g,"tr");for(var n=0,t=this.length;n<t;n++)c.call(b?Da(this[n],g):this[n],n>0||d.cacheable||this.length>1?l.cloneNode(true):l)}m.length&&jQuery.each(m,Ea)}return this}});jQuery.fragments={};jQuery.each({appendTo:"append",prependTo:"prepend",insertBefore:"before",insertAfter:"after",
...
document;for(var g=[],i=0,m;(m=a[i])!=null;i++){if(typeof m==="number")m+="";if(m){if(typeof m==="string"&&!Ta.test(m))m=b.createTextNode(m);else if(typeof m==="string"){m=m.replace(ua,wa);var l=(va.exec(m)||["",""])[1].toLowerCase(),n=G[l]||G._default,t=n[0],s=b.createElement("div");for(s.innerHTML=n[1]+m+n[2];t--;)s=s.lastChild;if(!jQuery.support.tbody){t=Sa.test(m);l=l==="table"&&!t?s.firstChild&&s.firstChild.childNodes:n[1]==="<table>"&&!t?s.childNodes:[];for(n=l.length-1;n>=0;--n)jQuery.nodeName(l[n],
"tbody")&&!l[n].childNodes.length&&l[n].parentNode.removeChild(l[n])}!jQuery.support.leadingWhitespace&&N.test(m)&&s.insertBefore(b.createTextNode(N.exec(m)[0]),s.firstChild);m=s.childNodes}if(m.nodeType)g.push(m);else g=jQuery.merge(g,m)}}if(c)for(i=0;g[i];i++)if(d&&jQuery.nodeName(g[i],"script")&&(!g[i].type||g[i].type.toLowerCase()==="text/javascript"))d.push(g[i].parentNode?g[i].parentNode.removeChild(g[i]):g[i]);else{g[i].nodeType===1&&g.splice.apply(g,[i+1,0].concat(jQuery.makeArray(g[i].getElementsByTagName("script"))));
c.appendChild(g[i])}return g},cleanData:function(a){for(var b,c,d=jQuery.cache,g=jQuery.event.special,i=jQuery.support.deleteExpando,m=0,l;(l=a[m])!=null;m++)if(!(l.nodeName&&jQuery.noData[l.nodeName.toLowerCase()]))if(c=l[jQuery.expando]){if((b=d[c])&&b.events)for(var n in b.events)g[n]?jQuery.event.remove(l,n):na(l,n,b.handle);if(i)delete l[jQuery.expando];else l.removeAttribute&&l.removeAttribute(jQuery.expando);delete d[c]}}});var Ua=/z-?index|font-?weight|opacity|zoom|line-?height/i,xa=/alpha\([^)]*\)/,
...
"=?");else if(!b.data||!J.test(b.data))b.data=(b.data?b.data+"&":"")+(b.jsonp||"callback")+"=?";b.dataType="json"}if(b.dataType==="json"&&(b.data&&J.test(b.data)||J.test(b.url))){c=b.jsonpCallback||"jsonp"+$a++;if(b.data)b.data=(b.data+"").replace(J,"="+c+"$1");b.url=b.url.replace(J,"="+c+"$1");b.dataType="script";var m=z[c];z[c]=function(p){g=p;jQuery.ajax.handleSuccess(b,u,d,g);jQuery.ajax.handleComplete(b,u,d,g);if(jQuery.isFunction(m))m(p);else{z[c]=x;try{delete z[c]}catch(h){}}t&&t.removeChild(s)}}if(b.dataType===
"script"&&b.cache===null)b.cache=false;if(b.cache===false&&i==="GET"){var l=jQuery.now(),n=b.url.replace(db,"$1_="+l+"$2");b.url=n+(n===b.url?($.test(b.url)?"&":"?")+"_="+l:"")}if(b.data&&i==="GET")b.url+=($.test(b.url)?"&":"?")+b.data;b.global&&jQuery.ajax.active++===0&&jQuery.event.trigger("ajaxStart");l=(l=eb.exec(b.url))&&(l[1]&&l[1]!==location.protocol||l[2]!==location.host);if(b.dataType==="script"&&i==="GET"&&l){var t=document.getElementsByTagName("head")[0]||document.documentElement,s=document.createElement("script");
...
arguments);else a==null||c?this.each(function(){var d=c?a:jQuery(this).is(":hidden");jQuery(this)[d?"show":"hide"]()}):this.animate(I("toggle",3),a,b);return this},fadeTo:function(a,b,c){return this.filter(":hidden").css("opacity",0).show().end().animate({opacity:b},a,c)},animate:function(a,b,c,d){var g=jQuery.speed(b,c,d);if(jQuery.isEmptyObject(a))return this.each(g.complete);return this[g.queue===false?"each":"queue"](function(){var i=jQuery.extend({},g),m,l=this.nodeType===1&&jQuery(this).is(":hidden"),
n=this;for(m in a){var t=m.replace(Y,Z);if(m!==t){a[t]=a[m];delete a[m];m=t}if(a[m]==="hide"&&l||a[m]==="show"&&!l)return i.complete.call(this);if((m==="height"||m==="width")&&this.style){i.display=jQuery.css(this,"display");i.overflow=this.style.overflow}if(jQuery.isArray(a[m])){(i.specialEasing=i.specialEasing||{})[m]=a[m][1];a[m]=a[m][0]}}if(i.overflow!=null)this.style.overflow="hidden";i.curAnim=jQuery.extend({},a);jQuery.each(a,function(s,w){var y=new jQuery.fx(n,i,s);if(gb.test(w))y[w==="toggle"?
l?"show":"hide":w](a);else{var u=hb.exec(w),D=y.cur(true)||0;if(u){w=parseFloat(u[2]);var E=u[3]||"px";if(E!=="px"){n.style[s]=(w||1)+E;D=(w||1)/y.cur(true)*D;n.style[s]=D+E}if(u[1])w=(u[1]==="-="?-1:1)*w+D;y.custom(D,w,E)}else y.custom(D,w,"")}});return true})},stop:function(a,b){var c=jQuery.timers;a&&this.queue([]);this.each(function(){for(var d=c.length-1;d>=0;d--)if(c[d].elem===this){b&&c[d](true);c.splice(d,1)}});b||this.dequeue();return this}});jQuery.each({slideDown:I("show",1),slideUp:I("hide",
...
jQuery.offset.initialize=jQuery.noop},bodyOffset:function(a){var b=a.offsetTop,c=a.offsetLeft;jQuery.offset.initialize();if(jQuery.offset.doesNotIncludeMarginInBodyOffset){b+=parseFloat(jQuery.curCSS(a,"marginTop",true))||0;c+=parseFloat(jQuery.curCSS(a,"marginLeft",true))||0}return{top:b,left:c}},setOffset:function(a,b,c){var d=jQuery.curCSS(a,"position");if(d==="static")a.style.position="relative";var g=jQuery(a),i=g.offset(),m=jQuery.curCSS(a,"top",true),l=jQuery.curCSS(a,"left",true),n=d==="absolute"&&
jQuery.inArray("auto",[m,l])>-1;d={};var t={};if(n)t=g.position();m=n?t.top:parseInt(m,10)||0;l=n?t.left:parseInt(l,10)||0;if(jQuery.isFunction(b))b=b.call(a,c,i);if(b.top!=null)d.top=b.top-i.top+m;if(b.left!=null)d.left=b.left-i.left+l;"using"in b?b.using.call(a,d):g.css(d)}};jQuery.fn.extend({position:function(){if(!this[0])return null;var a=this[0],b=this.offsetParent(),c=this.offset(),d=/^body|html$/i.test(b[0].nodeName)?{top:0,left:0}:b.offset();c.top-=parseFloat(jQuery.curCSS(a,"marginTop",
